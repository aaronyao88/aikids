...
generateEUI.skins = {"SceneBegin":"resource/game/SceneBegin.exml","GameSetting":"resource/game/GameSetting.exml","SceneLevel":"resource/game/SceneLevel.exml","LevelIcon":"resource/game/LevelIcon.exml","SceneGame":"resource/game/SceneGame.exml","Word":"resource/game/Word.exml"}
generateEUI.paths['resource/game/GameSetting.exml'] = window.GameSettingSkin = (function (_super) {
	...
	var SceneLevelSkin$Skin8 = 	(function (_super) {
		__extends(SceneLevelSkin$Skin8, _super);
		function SceneLevelSkin$Skin8() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = SceneLevelSkin$Skin8.prototype;
	...
	_proto.btn_back_i = function () {
		...
		t.x = 568;
		t.y = 1026;
		t.skinName = SceneLevelSkin$Skin8;
		return t;
	};
